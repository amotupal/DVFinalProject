libname library v7 'C:\Apps\SAS\FARS\2012\Annual\Programs\SAS\';
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DAYWK12F
01='Sunday'
02='Monday'
03='Tuesday'
04='Wednesday'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BKCGP12F
000='Not a Cyclist'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PDCGP12F
...
990='Other / Unknown - Insufficient Details'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DAY12F
01='1'
02='2'
03='3'
04='4'
...
31='31'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HOUR12F
00='0:00am-0:59am'
01='1:00am-1:59am'
02='2:00am-2:59am'
03='3:00am-3:59am'
...
99='Unknown Hours'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MINUT12F
00='0'
01='1'
02='2'
03='3'
...
99='Unknown Minutes'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MONTH12F
01='January'
02='February'
03='March'
04='April'
...
12='December'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ARRHR12F
00='0:00am-0:59am'
01='1:00am-1:59am'
02='2:00am-2:59am'
03='3:00am-3:59am'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ARRMN12F
00='0'
01='1'
02='2'
03='3'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ATMCD12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CZONE12F
00='None'
01='Construction'
02='Maintenance'
03='Utility'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FHE12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HOSHR12F
00='0:00am-0:59am'
01='1:00am-1:59am'
02='2:00am-2:59am'
03='3:00am-3:59am'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HOSMN12F
00='0'
01='1'
02='2'
03='3'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE INTTY12F
...
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE GPLAT12F
77.77770000='Not Reported'
88.88880000='Not Available'
99.99990000='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LGTCD12F
01='Daylight'
02='Dark - Not Lighted'
03='Dark - Lighted'
04='Dawn'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE GPLON12F
777.7777='Not Reported'
888.8888='Not Available'
999.9999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MCOLL12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MILPT12F
00000='None'
99998='Not Reported'
99999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NHS12F
00='This section IS NOT on the NHS'
01='This section IS ON the NHS'
09='Unknown if this section is on the NHS'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NOTHR12F
00='0:00am-0:59am'
01='1:00am-1:59am'
02='2:00am-2:59am'
03='3:00am-3:59am'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NOTMN12F
00='0'
01='1'
02='2'
03='3'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RLJCT12F
01='Non-Junction'
02='Intersection'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RJINT12F
0='No'
1='Yes'
8='Not Reported'
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RRDWY12F
01='On Roadway'
02='On Shoulder'
03='On Median'
04='On Roadside'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RFUN12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RTSGN12F
01='Interstate'
02='U.S. Highway'
03='State Highway'
04='County Road'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $RAIL12F
0000000='Not Applicable'
9999999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SCHBS12F
00='No'
01='Yes'
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SPJUR12F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE STATE12F
00001='Alabama'
00002='Alaska'
00004='Arizona'
00005='Arkansas'
...
00056='Wyoming'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ARF12F
00='None'
...
25='Toll-Plaza Related'
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SOE12F
01='Rollover/Overturn'
02='Fire/Explosion'
03='Immersion or Partial Immersion'
04='Gas Inhalation'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MDARS12F
01='1 Clock Value'
02='2 Clock Value'
03='3 Clock Value'
04='4 Clock Value'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CMLIC12F
00='No (CDL)'
01='Suspended'
02='Revoked'
03='Expired'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRF12F
00='None'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRZIP12F
00000='Not resident of U.S. or Territories'
99997='No Driver Present/Unknown if Driver Present'
99999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FLMON12F
00='No Record'
01='January'
02='February'
03='March'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FLYR12F
0000='No Record'
2005='2005'
2006='2006'
2009='2009'
...
9999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LCOMP12F
00='Not licensed'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CLEND12F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LREST12F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LSTAT12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NCDLS12F
00='Not licensed'
01='Suspended'
02='Revoked'
03='Expired'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CDLTP12F
00='Not Licensed'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PRACC12F
000='None'
001='1'
002='2'
003='3'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PRDWI12F
000='None'
001='1'
002='2'
003='3'
...
998='No Driver Present/Unknown if Driver Present'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SPDRL12F
00='No'
01='Yes'
08='No Driver Present/Unknown if Driver Present'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE WEGHT12F
040='40 lbs.'
041='41 lbs.'
042='42 lbs.'
043='43 lbs.'
...
999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE IMPAR12F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VIOL12F
00='None'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ACTAT12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ACTPR12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BKDIR12F
01='With Traffic'
02='Facing Traffic'
03='Not applicable'
07='Not a Cyclist'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BKPOS12F
01='Travel lane'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BCLOC12F
01='Intersection'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BCTYP12F
000='Not a Cyclist'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NIMPR12F
00='None/Apparently Normal'
01='Ill, Blackout'
02='Asleep or Fatigued'
03='Walking with a Cane or Crutches'
...
99='Unknown if Impaired'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PCLOC12F
01='Intersection'
02='Intersection-Related'
03='Non-intersection'
04='Non-Roadway'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PCTYP12F
000='Not a Pedestrian'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PDLEG12F
01='Near'
02='Far'
07='Not a Pedestrian'
08='Not Applicable'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MTDIR12F
01='North'
02='East'
03='South'
04='West'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MTMAN12F
01='Left Turn'
02='Right Turn'
03='Straight through'
07='Not a Pedestrian'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PDDIR12F
01='North'
02='East'
03='South'
04='West'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PDPOS12F
...
77='Not a Pedestrian'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $PDSN12F
7='Not a Pedestrian'
8='Not Applicable'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CWALK12F
00='No'
01='Yes'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SZONE12F
00='No'
01='Yes'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SWALK12F
00='No'
01='Yes'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SAFEQ12F
1='None Used'
2='Helmet'
...
9='Unknown if Used'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRIDR12F
0='No'
1='Yes'
8='Not Reported'
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DDAY12F
01='1'
02='2'
03='3'
04='4'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE AGE12F
...
999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE AIRBG12F
00='Not Applicable'
01='Deployed- Front'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRINK12F
00='No (Alcohol Not Involved)'
01='Yes (Alcohol Involved)'
08='Not Reported'
09='Unknown (Police Reported)'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ALCRS12F
00='0.00 % BAC'
01='0.01 % BAC'
02='0.02 % BAC'
03='0.03 % BAC'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ALCST12F
00='Test Not Given'
01='Test Refused'
02='Test Given'
08='Not Reported'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ALCTT12F
00='Test Not Given'
01='Blood'
02='Breathalyzer "BAC"'
03='Urine'
...
99='Unknown if Tested'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DOA12F
00='Not Applicable'
07='Died at Scene'
08='Died En Route'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRUG12F
00='No (drugs not involved)'
01='Yes (drugs involved)'
08='Not Reported'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRGRS12F
000='Test Not Given'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRGST12F
00='Test Not Given'
01='Test Refused'
02='Test Given'
08='Not Reported'
09='Unknown if Tested'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRGTT12F
00='Test Not Given'
01='Blood'
02='Urine'
...
09='Unknown if Tested'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DHOUR12F
00='0:00-0:59'
01='1:00-1:59'
02='2:00-2:59'
03='3:00-3:59'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DMIN12F
00='0'
01='1'
02='2'
03='3'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DMON12F
01='January'
02='February'
03='March'
04='April'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DYEAR12F
2009='2009'
2010='2010'
2011='2011'
2012='2012'
...
9999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE EJECT12F
00='Not Ejected'
01='Totally Ejected'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE EPATH12F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE EXTR12F
00='Not Extricated or Not Applicable'
01='Extricated'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HISPO12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE WKINJ12F
00='No'
01='Yes'
08='Not Applicable (not a fatality)'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE INJUR12F
00='No Injury (O)'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ALC_D12F
...
09='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRGDT12F
...
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PLOCT12F
...
99='Unknown Location'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PRF12F
00='None'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PTYPE12F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RACE12F
00='Not a Fatality (not Applicable)'
01='White'
02='Black'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RHUSE12F
00='Not Applicable'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RSTMU12F
0='No'
1='Yes'
8='Not a Motor Vehicle Occupant'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SEATP12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SEX12F
01='Male'
02='Female'
08='Not Reported'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE THOSP12F
00='Not Transported'
01='EMS Air'
02='Law Enforcement'
03='EMS Unknown Mode'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TRCN12F
00='No Controls'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ACCTP12F
00='No Impact'
01='Drive Off Road'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P3CRH12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P2CRH12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TCFUN12F
00='No Controls'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P5CRH12F
0='No Driver Present'
...
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P4CRH12F
0='No Driver Present'
1='Tracking'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CALGN12F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VALIG12F
00='Non-Trafficway Area'
01='Straight'
02='Curve Right'
03='Curve Left'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CGRAD12F
00='Non-Trafficway Area'
01='Level'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VGRAD12F
00='Non-Trafficway Area'
01='Level'
02='Grade, Unknown Slope'
03='Hillcrest'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SPLMT12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SURFC12F
00='Non-Trafficway Area'
01='Dry'
02='Wet'
03='Snow'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PAVET12F
00='Non-Trafficway Area'
01='Concrete'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TFLOW12F
00='Non-Trafficway Area'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LANES12F
00='Non-Trafficway Area'
01='One lane'
02='Two lanes'
03='Three lanes'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P1CRH12F
00='No Driver Present'
01='Going Straight'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FACTR12F
00='None'
01='Tires'
02='Brake System'
03='Steering'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MANVR12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRDIS12F
00='Not Distracted'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VISON12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $MCAR12F
00000000000='Not Applicable'
77777777777='Not Reported'
88888888888='None'
99999999999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BODY12F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BUSUS12F
00='Not a Bus'
01='School'
04='Intercity'
05='Charter/Tour'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CARBT12F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DEFOR12F
00='No Damage'
02='Minor Damage'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRIPR12F
0='No Driver Present/Not Applicable'
1='Yes'
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE EMERG12F
00='No'
01='Yes'
08='Not Reported'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FIRE12F
00='No or Not Reported'
01='Yes'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE GVWR12F
00='Not Applicable'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZIN12F
01='No'
02='Yes'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZPL12F
00='Not Applicable'
01='No'
02='Yes'
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZID12F
0000='Not Applicable'
8888='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZCN12F
00='Not Applicable'
01='01'
02='02'
03='03'
...
88='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZRL12F
00='Not Applicable'
01='No'
02='Yes'
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HIT12F
00='No'
01='Yes'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE IMPAC12F
00='Non-Collision'
01='1 Clock Value'
02='2 Clock Value'
03='3 Clock Value'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE JACKK12F
00='Not an Articulated Vehicle'
01='No'
02='Yes - First Event'
03='Yes - Subsequent Event'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TOWED12F
01='Driven Away'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MAKE12F
01='American Motors'
...
99='Unknown Make'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MCISA12F
00='Not Applicable'
01='Alabama'
02='Alaska'
03='American Samoa'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $MCID12F
000000000='Not Applicable'
777777777='Not Reported'
888888888='None'
999999999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MHARM12F
01='Rollover/Overturn'
02='Fire/Explosion'
03='Immersion or Partial Immersion'
04='Gas Inhalation'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MODYR12F
9998='Not Reported'
9999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NOCCS12F
00='00'
01='01'
02='02'
03='03'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE OWNER12F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE REGST12F
00='Not Applicable'
01='Alabama'
02='Alaska'
03='American Samoa'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ROLL12F
00='No Rollover'
01='Rollover, Tripped by Object/Vehicle'
02='Rollover, Untripped'
09='Rollover, Unknown Type'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RLOCT12F
0='No Rollover'
1='On Roadway'
2='On Shoulder'
...
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SPECU12F
00='No Special Use'
01='Taxi'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VTOW12F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TSPED12F
...
999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE UORID12F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE UNIT12F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VCONF12F
00='Not Applicable'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $VIN12F
000000000000='No VIN Required'
888888888888='Not Reported'
999999999999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VRF12F
00='None'

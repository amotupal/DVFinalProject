libname library v6 'C:\Apps\SAS\fars\2011\Final\Programs\sas';
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DAYWK11F
01='Sunday'
02='Monday'
03='Tuesday'
04='Wednesday'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BKCGP11F
000='Not a Cyclist'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PDCGP11F
...
990='Other / Unknown - Insufficient Details'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DAY11F
01='1'
02='2'
03='3'
04='4'
...
31='31'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HOUR11F
00='0:00am-0:59am'
01='1:00am-1:59am'
02='2:00am-2:59am'
03='3:00am-3:59am'
...
99='Unknown Hours'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MINUT11F
00='0'
01='1'
02='2'
03='3'
...
99='Unknown Minutes'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MONTH11F
01='January'
02='February'
03='March'
04='April'
...
12='December'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ARRHR11F
00='0:00am-0:59am'
01='1:00am-1:59am'
02='2:00am-2:59am'
03='3:00am-3:59am'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ARRMN11F
00='0'
01='1'
02='2'
03='3'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ATMCD11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CZONE11F
00='None'
01='Construction'
02='Maintenance'
03='Utility'
...
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FHE11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HOSHR11F
00='0:00am-0:59am'
01='1:00am-1:59am'
02='2:00am-2:59am'
03='3:00am-3:59am'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HOSMN11F
00='0'
01='1'
02='2'
03='3'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE INTTY11F
...
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE GPLAT11F
77.77770000='Not Reported'
88.88880000='Not Available'
99.99990000='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LGTCD11F
01='Daylight'
02='Dark - Not Lighted'
03='Dark - Lighted'
04='Dawn'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE GPLON11F
777.77770000='Not Reported'
888.88880000='Not Available'
999.99990000='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MCOLL11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MILPT11F
00000='None'
99998='Not Reported'
99999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NHS11F
00='This section IS NOT on the NHS'
01='This section IS ON the NHS'
09='Unknown if this section is on the NHS'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NOTHR11F
00='0:00am-0:59am'
01='1:00am-1:59am'
02='2:00am-2:59am'
03='3:00am-3:59am'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NOTMN11F
00='0'
01='1'
02='2'
03='3'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RLJCT11F
01='Non-Junction'
02='Intersection'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RJINT11F
0='No'
1='Yes'
8='Not Reported'
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RRDWY11F
01='On Roadway'
02='On Shoulder'
03='On Median'
04='On Roadside'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RFUN11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RTSGN11F
01='Interstate'
02='U.S. Highway'
03='State Highway'
04='County Road'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $RAIL11F
0000000='Not Applicable'
9999999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SCHBS11F
00='No'
01='Yes'
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SPJUR11F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE STATE11F
00001='Alabama'
00002='Alaska'
00004='Arizona'
00005='Arkansas'
...
00056='Wyoming'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ARF11F
00='None'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SOE11F
01='Rollover/Overturn'
02='Fire/Explosion'
03='Immersion'
04='Gas Inhalation'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CMLIC11F
00='No (CDL)'
01='Suspended'
02='Revoked'
03='Expired'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRF11F
00='None'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRZIP11F
00000='Not resident of U.S. or Territories'
99997='No Driver Present/Unknown if Driver Present'
99999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FLMON11F
00='No Record'
01='January'
02='February'
03='March'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FLYR11F
0000='No Record'
2005='2005'
2006='2006'
2008='2008'
...
9999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LCOMP11F
00='Not licensed'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CLEND11F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LREST11F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LSTAT11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NCDLS11F
00='Not licensed'
01='Suspended'
02='Revoked'
03='Expired'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CDLTP11F
00='Not Licensed'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PRACC11F
000='None'
001='1'
002='2'
003='3'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PRDWI11F
000='None'
001='1'
002='2'
003='3'
...
998='No Driver Present/Unknown if Driver Present'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SPDRL11F
00='No'
01='Yes'
08='No Driver Present/Unknown if Driver Present'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE WEGHT11F
040='40 lbs.'
041='41 lbs.'
042='42 lbs.'
043='43 lbs.'
...
999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE IMPAR11F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VIOL11F
00='None'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ACTAT11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ACTPR11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BKDIR11F
01='With Traffic'
02='Facing Traffic'
03='Not applicable'
07='Not a Cyclist'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BKPOS11F
01='Travel lane'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BCLOC11F
01='Intersection'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BCTYP11F
000='Not a Cyclist'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NIMPR11F
00='None/Apparently Normal'
01='Ill, Blackout'
02='Asleep or Fatigued'
03='Walking with a Cane or Crutches'
...
99='Unknown if Impaired'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PCLOC11F
01='Intersection'
02='Intersection-Related'
03='Non-intersection'
04='Non-Roadway'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PCTYP11F
000='Not a Pedestrian'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PDLEG11F
01='Near'
02='Far'
07='Not a Pedestrian'
08='Not Applicable'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MTDIR11F
01='North'
02='East'
03='South'
04='West'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MTMAN11F
01='Left Turn'
02='Right Turn'
03='Straight through'
07='Not a Pedestrian'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PDDIR11F
01='North'
02='East'
03='South'
04='West'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PDPOS11F
...
77='Not a Pedestrian'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $PDSN11F
7='Not a Pedestrian'
8='Not Applicable'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CWALK11F
00='No'
01='Yes'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SZONE11F
00='No'
01='Yes'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SWALK11F
00='No'
01='Yes'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SAFEQ11F
1='None Used'
2='Helmet'
...
9='Unknown if Used'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRIDR11F
0='No'
1='Yes'
8='Not Reported'
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DDAY11F
01='1'
02='2'
03='3'
04='4'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE AGE11F
...
999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE AIRBG11F
00='Not Applicable'
01='Deployed- Front'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRINK11F
00='No (Alcohol Not Involved)'
01='Yes (Alcohol Involved)'
08='Not Reported'
09='Unknown (Police Reported)'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ALCRS11F
00='0.00 % BAC'
01='0.01 % BAC'
02='0.02 % BAC'
03='0.03 % BAC'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ALCST11F
00='Test Not Given'
01='Test Refused'
02='Test Given'
08='Not Reported'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ALCTT11F
00='Test Not Given'
01='Blood'
02='Breathalyzer "BAC"'
03='Urine'
...
99='Unknown if Tested'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DOA11F
00='Not Applicable'
07='Died at Scene'
08='Died En Route'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRUG11F
00='No (drugs not involved)'
01='Yes (drugs involved)'
08='Not Reported'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRGRS11F
000='Test Not Given'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRGST11F
0='Test Not Given'
1='Test Refused'
2='Test Given'
8='Not Reported'
9='Unknown if Tested'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRGTT11F
00='Test Not Given'
01='Blood'
02='Urine'
...
09='Unknown if Tested'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DHOUR11F
00='0:00-0:59'
01='1:00-1:59'
02='2:00-2:59'
03='3:00-3:59'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DMIN11F
00='0'
01='1'
02='2'
03='3'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DMON11F
01='January'
02='February'
03='March'
04='April'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DYEAR11F
2009='2009'
2010='2010'
2011='2011'
2012='2012'
...
9999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE EJECT11F
00='Not Ejected'
01='Totally Ejected'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE EPATH11F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE EXTR11F
00='Not Extricated or Not Applicable'
01='Extricated'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HISPO11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE WKINJ11F
00='No'
01='Yes'
08='Not Applicable (not a fatality)'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE INJUR11F
00='No Injury (O)'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ALC_D11F
...
09='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRGDT11F
...
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PLOCT11F
...
99='Unknown Location'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PRF11F
00='None'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PTYPE11F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RACE11F
00='Not a Fatality (not Applicable)'
01='White'
02='Black'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RHUSE11F
00='Not Applicable'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RSTMU11F
0='No'
1='Yes'
8='Not a Motor Vehicle Occupant'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SEATP11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SEX11F
01='Male'
02='Female'
08='Not Reported'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE THOSP11F
00='Not Transported'
01='EMS Air'
02='Law Enforcement'
03='EMS Unknown Mode'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TRCN11F
00='No Controls'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ACCTP11F
00='M0-No Impact'
...
93='M93-Backing-Other Veh. or Object'
98='M98-Other Crash Type'
99='M99-Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P3CRH11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P2CRH11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TCFUN11F
00='No Controls'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P5CRH11F
0='No Driver Present'
...
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P4CRH11F
0='No Driver Present'
1='Tracking'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CALGN11F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VALIG11F
00='Non-Trafficway Area'
01='Straight'
02='Curve Right'
03='Curve Left'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CGRAD11F
00='Non-Trafficway Area'
01='Level'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VGRAD11F
00='Non-Trafficway Area'
01='Level'
02='Grade, Unknown Slope'
03='Hillcrest'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SPLMT11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SURFC11F
00='Non-Trafficway Area'
01='Dry'
02='Wet'
03='Snow'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE PAVET11F
00='Non-Trafficway Area'
01='Concrete'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TFLOW11F
00='Non-Trafficway Area'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE LANES11F
00='Non-Trafficway Area'
01='One lane'
02='Two lanes'
03='Three lanes'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE P1CRH11F
00='No Driver Present'
01='Going Straight'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FACTR11F
00='None'
01='Tires'
02='Brake System'
03='Steering'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MANVR11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRDIS11F
00='Not Distracted'
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VISON11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $MCAR11F
00000000000='Not Applicable'
77777777777='Not Reported'
88888888888='None'
99999999999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BODY11F
...
97='Other vehicle type (includes go-cart, fork-lift, city street sweeper dunes/swamp buggy, golf cart)'
98='Not Reported'
99='Unknown body type'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE BUSUS11F
00='Not a Bus'
01='School'
04='Intercity'
05='Charter/Tour'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE CARBT11F
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DEFOR11F
00='No Damage'
02='Minor Damage'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE DRIPR11F
00='No Driver Present/Not Applicable'
01='Yes'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE EMERG11F
00='No'
01='Yes'
08='Not Reported'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE FIRE11F
00='No or Not Reported'
01='Yes'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE GVWR11F
00='Not Applicable'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZIN11F
01='No'
02='Yes'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZPL11F
00='Not Applicable'
01='No'
02='Yes'
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZID11F
0000='Not Applicable'
8888='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZCN11F
00='Not Applicable'
01='01'
02='02'
03='03'
...
88='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HAZRL11F
00='Not Applicable'
01='No'
02='Yes'
08='Not Reported'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE HIT11F
00='No'
01='Yes'
08='Not Reported'
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE JACKK11F
00='Not an Articulated Vehicle'
01='No'
02='Yes - First Event'
03='Yes - Subsequent Event'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TOWED11F
01='Driven Away'
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MAKE11F
01='American Motors'
...
99='Unknown Make'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MCISA11F
00='Not Applicable'
01='Alabama'
02='Alaska'
03='American Samoa'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $MCID11F
000000000='Not Applicable'
777777777='Not Reported'
888888888='None'
999999999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MHARM11F
01='Rollover/Overturn'
02='Fire/Explosion'
03='Immersion'
04='Gas Inhalation'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE MODYR11F
9998='Not Reported'
9999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE NOCCS11F
00='00'
01='01'
02='02'
03='03'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE IMPAC11F
00='Non-Collision'
01='1 Clock Point'
02='2 Clock Point'
03='3 Clock Point'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE OWNER11F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE REGST11F
00='Not Applicable'
01='Alabama'
02='Alaska'
03='American Samoa'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE ROLL11F
00='No Rollover'
01='Rollover, Tripped by Object/Vehicle'
02='Rollover, Untripped'
09='Rollover, Unknown Type'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE RLOCT11F
0='No Rollover'
1='On Roadway'
2='On Shoulder'
...
9='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE SPECU11F
00='No Special Use'
01='Taxi'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VTOW11F
...
09='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE TSPED11F
...
999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE UORID11F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE UNIT11F
...
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VCONF11F
00='Not Applicable'
...
99='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE $VIN11F
000000000000='No VIN Required'
888888888888='Not Reported'
999999999999='Unknown'
;
PROC FORMAT LIBRARY=LIBRARY PRINT; VALUE VRF11F
00='None'
